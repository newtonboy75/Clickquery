...
public class GetUserTimez extends Activity {
    ListView list;
    TextView ver;
    TextView name;
    TextView api;
    ...
    private static String url = "http://dev.mob-z.com/clickquery/index.php?q=2";
    //JSON Node Names
    ...
    private class JSONParse extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(GetUserTimez.this);
        ...
        protected JSONObject doInBackground(String... args) {
         ...
         protected void onPostExecute(JSONObject json) {
             ...
             try {
                    ...
                    ListAdapter adapter = new SimpleAdapter(GetUserTimez.this, oslist,
                            R.layout.list_result_time,
