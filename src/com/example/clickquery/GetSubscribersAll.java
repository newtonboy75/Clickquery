...
public class GetSubscribersAll extends Activity {
    ListView list;
    TextView ver;
    TextView name;
    TextView api;
    ...
    private static String url = "http://dev.mob-z.com/clickquery/index.php?q=1";
    //JSON Node Names
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_result_subscribersall);
        ...
        //mTable.addView(addRow("Date", "New Subscribers"));
          ...
          private TableRow addRow(String dname, String dpid) {
             ...
             tr = new TableRow(GetSubscribersAll.this);
    ...
    private class JSONParse extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(GetSubscribersAll.this);
